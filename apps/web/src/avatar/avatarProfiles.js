...
export const AVATAR_PROFILES = {
  ...
  aria: {
    ...
    visemeWeights: {
      aa: 0.68, ih: 0.6, ou: 0.65, ee: 0.62, oh: 0.65,
      v_pp: 0.7, v_ff: 0.58, v_th: 0.6, v_dd: 0.62, v_kk: 0.62,
      v_ch: 0.62, v_ss: 0.58, v_nn: 0.55, v_rr: 0.6, neutral: 0.0,
    },
  },
  ...
  zhenja: {
    ...
    visemeWeights: {
      ...
      v_pp: 0.62, v_ff: 0.46, v_th: 0.48, v_dd: 0.5, v_kk: 0.5,
      v_ch: 0.5, v_ss: 0.46, v_nn: 0.44, v_rr: 0.48, neutral: 0.0,
    },
  },
};
...
export const getAvatarProfile = (id) =>
  AVATAR_PROFILES[id] ?? AVATAR_PROFILES[DEFAULT_AVATAR_ID];
