...
export function SourceDrawer({ isMobile }) {
  ...
  const metaLine = art
    ? `Reviewed content · ${art.mins} min read`
    : drawer.org
      ? `Source: ${drawer.org}`
  ...
  return (
    <>
      <div
        onClick={close}
        style={{ position: 'fixed', inset: '0', background: 'rgba(15,25,32,.45)', zIndex: '60' }}
      />
      <div
        role="dialog"
        ...
        style={{
          ...
          boxShadow: '0 8px 40px rgba(10,20,28,.3)',
          display: 'flex',
          ...
          width: isMobile ? 'auto' : 'min(440px,92vw)',
      ...
      >
        ...
        <span
          style={{
            ...
            fontSize: '.82rem',
            fontWeight: '600',
            background: y ? y.bg : 'var(--tint)',
            color: y ? y.fg : 'var(--primary-d)',
          }}
        >
          <span
            style={{
              ...
              height: '7px',
              borderRadius: '50%',
              background: y ? y.dot : 'var(--primary)',
            }}
          />
          {chipLabel}
        </span>
        ...
        {articleId && (
          <button
            onClick={() => {
              close();
              navigate('#/app/library/' + articleId);
            }}
            style={{
              minHeight: '50px',
              borderRadius: '14px',
  ...
  return (
    <div
      ...
      style={{
        ...
        borderRadius: '999px',
        fontWeight: '600',
        boxShadow: '0 4px 18px rgba(10,20,28,.3)',
        maxWidth: '90vw',
      }}
    >
      {toast}
