...
export const CATS = [
  {
    id: 'caregiving',
    name: 'Caregiving Advice',
    desc: 'Practical daily care tips and strategies',
    accent: '#E8956D',
    pale: '#FBEEE6',
    dk: '#3A2A20',
  },
  {
    ...
    desc: 'Evidence-based medical recommendations',
    accent: '#4A7C8E',
    pale: '#EBF3F6',
    dk: '#16303A',
  },
  {
    id: 'best',
    name: 'Best Practices',
    desc: 'Research-backed behavioural care approaches',
    accent: '#F0C070',
    pale: '#FCF3DF',
    dk: '#39301B',
  },
  {
    id: 'communication',
    name: 'Communication',
    desc: 'Connecting with loved ones with dementia',
    accent: '#9B8DC4',
    pale: '#F0EDF8',
    dk: '#2A2538',
  },
  {
    id: 'safety',
    name: 'Home Safety',
    desc: 'Making the home safe for someone with dementia',
    accent: '#D4756B',
    pale: '#F9E9E7',
    dk: '#37211F',
  },
  {
    id: 'wellbeing',
    name: 'Carer Wellbeing',
    desc: 'Supporting the health and resilience of family carers',
    accent: '#7FB5A0',
    pale: '#EAF4F0',
    dk: '#1F2F29',
  },
  {
    ...
    desc: 'Risk factors, warning signs, and brain health strategies',
    accent: '#5B9BD5',
    pale: '#E7F0FA',
    dk: '#1B2A3A',
  },
...
export const ARTICLES = [
  A(
    ...
    'Why late-day restlessness happens and calm ways to respond',
    7
  ),
  A(
    'safe-home',
    ...
    'Simple changes that prevent accidents and reduce worry',
    6
  ),
  A(
    'hygiene-bathing',
    ...
    'Respectful, low-stress approaches to washing and grooming',
    6
  ),
  A(
    'mealtimes',
    'caregiving',
    'Mealtimes and Nutrition Support',
  ...
  A(
    ...
    'Structure that reassures without feeling rigid',
    5
  ),
  A(
    'continence',
    ...
    'Practical help while protecting self-respect',
    6
  ),
  A(
    'sleep-rest',
    ...
    'Gentle ways to improve nights for everyone',
    5
  ),
  A(
    'stages',
    ...
    'What mild, moderate and severe stages usually look like',
    8
  ),
  A(
    'medications',
    ...
    'Common medicines, what they do, and what to watch for',
    7
  ),
  A(
    'urgent-review',
    ...
    'Changes that need a doctor today, not next week',
    4
  ),
  A(
    'types',
    ...
    "Alzheimer's, vascular, Lewy body and others in plain language",
    7
  ),
  A(
    'gp-specialists',
    ...
    'Getting the most from appointments and referrals',
    5
  ),
  A(
    'pain',
    ...
    'Spotting pain when someone cannot say they hurt',
    6
  ),
  A(
    'diagnosis',
    ...
    'What the diagnosis means and sensible next steps',
    6
  ),
  A(
    'repetitive',
    'best',
    'Responding to Repetitive Questions and Actions',
    'Why repetition happens and kind ways to respond',
    5
  ),
  A(
    'aggression',
    'best',
    'Handling Physical Aggression and Agitation',
    'Staying safe and calm when behaviour escalates',
    8
  ),
  A(
    'burnout',
    'best',
    'Carer Wellbeing and Burnout Prevention',
    'Recognising burnout early and protecting yourself',
    10
  ),
  A(
    'person-centred',
    ...
    'Seeing the person first, the dementia second',
    6
  ),
  A(
    'music-reminiscence',
    'best',
    'Using Music and Reminiscence',
    'Memory-friendly activities that lift mood',
    5
  ),
  ...
  A(
    ...
    'Meeting someone in their reality, not arguing with it',
    5
  ),
  A(
    ...
    'Conversation techniques that reduce frustration',
    5
  ),
  A(
    'talking-diagnosis',
    ...
    'Honest, gentle conversations with the person and whānau',
    6
  ),
  A(
    'non-verbal',
    ...
    'Tone, touch and body language when words fade',
    5
  ),
  A(
    'driving',
    ...
    'Raising driving safety without a battle',
    6
  ),
  A(
    'staying-connected',
    'communication',
    'Keeping Connections with Family and Friends',
    'Helping relationships survive the diagnosis',
    5
  ),
  A(
    ...
    'Staying connected when speech is largely gone',
    6
  ),
  A(
    'visiting',
    ...
    'Making visits calm, positive and worthwhile',
    4
  ),
  A(
    'wandering',
    'safety',
    'Wandering Prevention and Safe-Return Strategies',
    'Reducing risk and planning for if someone goes missing',
    7
  ),
  A(
    'anxiety-environment',
    ...
    'How light, noise and layout affect behaviour',
    6
  ),
  A(
    'kitchen-bathroom',
    ...
    'Managing the two highest-risk rooms in the house',
    5
  ),
  A(
    'falls',
    ...
    'Simple fixes that dramatically cut fall risk',
    6
  ),
  A(
    'wayfinding',
    ...
    'Helping someone find their way around home',
    5
  ),
  A(
    'home-technology',
    ...
    'Sensors, locators and reminders — what is worth it',
    6
  ),
  A(
    'doors',
    'safety',
    'Securing Doors Without Locking Someone In',
    'Balancing safety with freedom and dignity',
    5
  ),
  A(
    'carer-stress',
    ...
    'Early warning signs that you need more support',
    5
  ),
  A(
    'respite',
    ...
    'In-home, day programme and residential respite in NZ',
    7
  ),
  A(
    'accepting-help',
    ...
    'Why it is hard, and scripts that make it easier',
    5
  ),
  ...
  A(
    ...
    'Your health checks matter as much as theirs',
    5
  ),
  A(
    'support-groups',
    ...
    'Finding your people through Dementia NZ and Alzheimers NZ',
    4
  ),
  A(
    'work-caring',
    ...
    'Your rights, flexible work and realistic limits',
    6
  ),
  A(
    'early-signs',
    ...
    'Changes that go beyond normal ageing',
    6
  ),
  A(
    'risk-factors',
    ...
    'The 12 modifiable risks and what they mean for you',
    7
  ),
  A(
    'brain-habits',
    ...
    'Everyday choices that support brain health',
    5
  ),
  A(
    'hearing-vision',
    ...
    'Why treating hearing loss protects the brain',
    5
  ),
  A(
    'normal-ageing',
    'prevention',
    'When Forgetfulness Is Normal Ageing',
    'Telling everyday lapses apart from warning signs',
    4
  ),
  A(
    'memory-assessment',
    ...
    'What happens at a memory clinic and how to prepare',
    6
  ),
  A(
    'heart-brain',
    ...
    'Blood pressure, exercise and dementia risk',
    5
  ),
];
...
export const relatedTo = (a) =>
  ARTICLES.filter((x) => x.cat === a.cat && x.id !== a.id).slice(0, 3);
export const searchArticles = (q) => {
  const t = q.trim().toLowerCase();
  if (!t) return ARTICLES;
  return ARTICLES.filter((a) =>
    (a.title + ' ' + a.sum + ' ' + getCat(a.cat).name).toLowerCase().includes(t)
  );
};
...
const SUNDOWNING = [
  {
    t: 'p',
    x: 'Many people living with dementia become more restless, confused or upset as the afternoon turns into evening. Carers often describe pacing, calling out, wanting to "go home" (even at home), or becoming suspicious or tearful. This pattern is called sundowning, and it is one of the most common — and most exhausting — parts of dementia care.',
  },
  {
    t: 'p',
    x: 'If evenings are hard in your house, you are not doing anything wrong. Sundowning is driven by changes in the brain, not by anything you have failed to do.',
  },
  { t: 'h', x: 'Why it happens' },
  {
    t: 'p',
    x: 'The body clock that tells us when to be alert and when to wind down is often damaged by dementia. Add in end-of-day tiredness, fading light, long shadows, household busy-ness around dinner time, and unmet needs like hunger, thirst, pain or needing the toilet — and late afternoon becomes a perfect storm.',
  },
  {
    t: 'tip',
    x: 'Try this: for a week, jot down when the restlessness starts and what was happening just before. Patterns — a certain time, the TV news, an empty stomach — usually appear quickly, and they tell you what to change.',
  },
  { t: 'h', x: 'What you can try in the late afternoon' },
  {
    t: 'p',
    x: 'Keep the second half of the day calm and predictable. A quiet activity after lunch, a light snack around 3pm, and curtains closed with warm lamps on before dusk (so the light change is gentle, not sudden) all help. Turn off background noise you are not actively listening to — a radio and a TV at once is a lot for a tired brain.',
  },
  {
    t: 'tip',
    x: 'Try this: a short walk or time in natural light around midday helps reset the body clock and often makes evenings noticeably calmer.',
  },
  { t: 'h', x: 'In the moment' },
  {
    t: 'p',
    x: 'Stay calm and keep your voice low and warm — your mood is contagious. Do not argue with what they believe is happening; respond to the feeling instead ("You sound worried. I\'m here, you\'re safe"). Redirection works better than correction: offer a cup of tea, a familiar task like folding washing, or a favourite piece of music.',
  },
  {
    t: 'p',
    x: 'If they want to walk, walking with them for a few minutes is usually safer and kinder than trying to stop them.',
  },
  {
    t: 'warn',
    x: 'When to seek help: if agitation regularly puts anyone at risk, or if confusion worsens suddenly over a day or two (this can signal an infection or delirium), contact your GP or call Healthline on 0800 611 116. In an emergency, call 111.',
  },
  { t: 'h', x: 'Look after yourself too' },
  {
    t: 'p',
    x: 'Sundowning lands at exactly the time of day when you are most tired yourself. If evenings are consistently hard, that is a good reason to ask about respite or an evening support worker — see the Carer Wellbeing section of this library. Needing help with the hardest hours is normal, not a failure.',
  },
];
  ...
  return [
    {
      ...
      x:
        a.sum +
        '. This guide brings together practical, plain-language advice from trusted ' +
        c.name.toLowerCase() +
        ' sources, written for family carers, care workers and health professionals in Aotearoa New Zealand.',
    },
    { t: 'h', x: 'What helps' },
    {
      t: 'p',
      x: 'Start small. Choose one change that feels manageable this week and give it a few days before judging whether it helps. Most strategies work best when they become part of a steady routine rather than a one-off fix, and every person with dementia is different — expect a little trial and error.',
    },
    {
      t: 'tip',
      x: 'Try this: keep short notes about what you tried and what happened. Patterns often show up within a week or two, and your notes are genuinely useful to share with your GP or nurse.',
    },
    {
      t: 'p',
      x: 'If something does not work today, it may still work on a calmer day. And if you are unsure where to start, ask Aria — she can point you to the most relevant part of this library, with sources.',
    },
    {
      t: 'warn',
      x: 'When to seek help: if there is a sudden change in behaviour, alertness or ability, contact your GP or call Healthline on 0800 611 116. In an emergency, call 111.',
    },
  ];
}

export const tagsFor = (a) =>
  a.id === 'managing-sundowning'
    ? ['Evening routine', 'Behaviour', 'Agitation']
    : [getCat(a.cat).name, 'Practical guide'];
...
export const FEATURED = [
  { id: 'stages', mins: 8 },
  { id: 'safe-home', mins: 6 },
  { id: 'memory-loss-communication', mins: 5 },
  { id: 'burnout', mins: 10 },
];

export const SAFETY_NOTE =
  'If anyone is in immediate danger, call 111. For urgent health advice any time, call Healthline on 0800 611 116 — free, 24 hours.';

const cite = (ids) =>
  ids.map((id) => {
    const a = getArticle(id);
    return { id: a.id, title: a.title, cat: a.cat };
  });
const R = (long, short, ids, safety) => ({ long, short, citations: cite(ids), safety: !!safety });

const REPLIES = [
  {
    k: ['sundown', 'evening', 'restless at night'],
    r: R(
  ...
  {
    k: ['early sign', 'first sign', 'warning sign'],
    r: R(
  ...
  {
    k: ['aggress', 'aggres', 'hit', 'violen', 'angry', 'lash'],
    r: R(
...
export function mockReply(q, settings, opts = {}) {
  ...
  if (hit)
    return {
      text: concise ? hit.r.short : hit.r.long,
      citations: hit.r.citations,
      safety: hit.r.safety,
    };
  const generic = R(
  ...
  return {
    text: concise ? generic.short : generic.long,
...
export function seedThread() {
  ...
  return [
    ...
    {
      role: 'user',
      text: 'Some evenings he lashes out at me and I get scared. What should I do?',
      time: '9:44 am',
    },
