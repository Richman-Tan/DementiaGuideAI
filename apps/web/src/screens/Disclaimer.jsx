...
export default function Disclaimer() {
  ...
  // The resolved avatar's name; copy stays pronoun-free because the roster is
  // mixed (see the convention note in @core/study/studyConfig.mjs).
  ...
  return (
    <section style={{ padding: '32px 0 48px', maxWidth: '680px' }}>
      ...
      <p style={{ lineHeight: '1.7', margin: '0 0 16px' }}>DementiaGuide AI provides general information about dementia and dementia care. {`It is not a medical service, and ${who} is not a doctor, nurse, or health professional.`}</p>
      ...
      <p style={{ lineHeight: '1.7', margin: '0 0 16px' }}>{`${who}'s answers are grounded in a curated library of reviewed articles, with the sources shown so you can check them. Even so, AI systems can make mistakes. If something ${who} says seems wrong or doesn't fit your situation, trust your judgement and check with a professional.`}</p>
