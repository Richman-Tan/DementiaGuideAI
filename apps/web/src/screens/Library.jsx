...
export default function Library() {
  ...
  return (
    <section style={{ padding: '28px 0 48px' }}>
      ...
      >
        Trusted, curated dementia-care guidance — the same knowledge Aria uses.
      </p>
      <div
        style={{
          display: 'flex',
      ...
      {filtered.length > 0 ? (
            ...
            return (
              ...
              >
                <span style={{ flex: '1', minWidth: '220px' }}>
                  <span style={{ display: 'block', fontWeight: '700', fontSize: '1.02rem' }}>
                    {a.title}
                  </span>
                  <span
                    style={{
                ...
                <span style={{ color: 'var(--text2)', fontSize: '.88rem', whiteSpace: 'nowrap' }}>
                  {a.mins} min
                </span>
              </button>
            );
        ...
        >
          ...
          <p style={{ margin: '0', color: 'var(--text2)' }}>
            Try different words — or ask Aria in Chat instead; she can search the whole library for
            you.
          </p>
          <button
            onClick={go('#/app/chat')}
