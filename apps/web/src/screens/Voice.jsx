...
function StatusChip({ vState, who }) {
  ...
  return (
    ...
    >
      ...
      {vState === 'speaking' && (
        <span
          style={{ display: 'flex', alignItems: 'center', gap: '3px', height: '18px' }}
          aria-hidden="true"
        >
          {[0, 0.12, 0.24, 0.36].map((d) => (
            <span
              ...
              style={{
                ...
                animation: `dgBar .8s ease-in-out ${d}s infinite`,
              }}
            />
          ))}
        </span>
  ...
  return (
    ...
    >
      ...
      <p style={{ margin: 0, color: 'var(--text2)', fontSize: '.95rem', lineHeight: 1.5 }}>
        To talk with {who}, add your OpenAI key. Your keys are stored only in this browser — they
      ...
      {field(
        ...
        'eleven',
        'Optional',
        `Optional — gives ${who} a more natural voice and better lip movement.`
      )}
      <button
        onClick={onSave}
        disabled={!canSave}
...
export default function Voice() {
  ...
  const { vState, vTranscript, vDone, vSubtitle, micTap, askText, repeatLast, error, clearError } =
  ...
  const closeVoice = () => {
    history.length > 1 ? history.back() : navigate('#/app/home');
  };
  const saveSetup = () => {
    saveKeys(keys);
    setSavedKeys(keys);
  ...
  return (
    <section
      style={{
        ...
        zIndex: 50,
        overflow: 'hidden',
        background: 'radial-gradient(circle at 50% 30%, var(--tint) 0%, var(--bg) 80%)',
      }}
    >
        ...
        >
            ...
            {vListening && (
              <span
                ...
                style={{
                  ...
                  animation: 'dgPulse 1.6s ease-out infinite',
                }}
              />
            )}
            <button
              ...
              style={{
                ...
                alignItems: 'center',
                justifyContent: 'center',
                boxShadow: '0 6px 22px rgba(45,95,112,.45)',
              }}
            >
              <MicIcon />
            </button>
          ...
          >
            <button
              ...
              aria-label={muted ? `Unmute ${who}` : `Mute ${who}`}
              ...
              style={{
                ...
                borderRadius: '12px',
                border: 'none',
                background: muted ? 'var(--amber-bg)' : 'var(--elev)',
                color: muted ? 'var(--amber)' : 'var(--text2)',
                cursor: 'pointer',
                display: 'flex',
                alignItems: 'center',
                justifyContent: 'center',
            ...
            <button
              ...
              style={{
                ...
                borderRadius: '12px',
                border: 'none',
                background: draft.trim() && canType ? 'var(--primary)' : 'var(--elev)',
                color: draft.trim() && canType ? '#fff' : 'var(--text2)',
                cursor: draft.trim() && canType ? 'pointer' : 'default',
                display: 'flex',
                alignItems: 'center',
                justifyContent: 'center',
              }}
      ...
      {panel && (
        <div
          style={{
            ...
            boxShadow: '0 -8px 30px rgba(10,20,28,.25)',
            padding: '20px',
            boxSizing: 'border-box',
            display: 'flex',
            flexDirection: 'column',
