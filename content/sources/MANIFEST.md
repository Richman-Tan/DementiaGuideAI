...
+ `docs/rag/rag-source-inventory.md`). This manifest IS committed and records what
...
| `dg-curated-delirium-2026-09.txt` (DRAFT, committed) | n/a — team-authored 2026-09-09; adapted from the DementiaGuide web library articles (clinical/stages, clinical/medications, clinical/urgent-review, safety), which are grounded per docs/web/library-source-map.md | 2026-09-09 | `7f3540ac523d563c1be4f0d0283005cfeec291d2b53f91d0d533fa8b064e2798` (re-hash after the draft header is removed at sign-off) | Internal — our own authorship. **Gate: clinician (Sarah) sign-off required before `enabled:true`**; prompted by 2026-09-08 pilot feedback (sleepiness answer missed delirium) |
