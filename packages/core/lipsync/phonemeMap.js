...
export const CHAR_TO_VISEME = {
  ...
  I: 'ih', // "bit", "sit"
  y: 'ih',
  Y: 'ih', // "yes" (palatal glide)
  u: 'ou',
  U: 'ou', // "put", "use"
  w: 'ou',
  W: 'ou', // "we" (labial-velar glide)
  o: 'oh',
  O: 'oh', // "go", "no"
  e: 'ee',
  E: 'ee', // "see", "be"
  ...
  // ── Bilabials ─────────────────────────────────────────────────────────────
  m: 'v_pp',
  M: 'v_pp', // nasal — lips close visibly (lower weight via CHAR_WEIGHT_OVERRIDE)
  b: 'v_pp',
  B: 'v_pp', // voiced bilabial stop
  p: 'v_pp',
  P: 'v_pp', // voiceless bilabial stop
  ...
  Z: 'v_ss',
  l: 'v_nn',
  L: 'v_nn', // lateral alveolar — same articulator region as n

  // ── Velars ────────────────────────────────────────────────────────────────
  k: 'v_kk',
  K: 'v_kk',
  g: 'v_kk',
  G: 'v_kk', // default hard-g; soft-g (gentle) handled by digraph
  c: 'v_kk',
  C: 'v_kk', // default hard-c; soft-c (city) handled by digraph
  q: 'v_kk',
  Q: 'v_kk', // qu = kw
  x: 'v_kk',
  X: 'v_kk', // ks
  ...
  // ── Affricates ────────────────────────────────────────────────────────────
  j: 'v_ch',
  J: 'v_ch', // "joy" — dʒ affricate, same shape as CH

  // ── Aspiration (nearly invisible articulation) ────────────────────────────
  h: 'neutral',
  H: 'neutral', // pure aspiration — no visible lip/jaw movement
};
...
export const VISEME_WEIGHT = {
  ...
  ih: 0.6, // front vowel — narrow, minimal jaw
  ...
  v_pp: 0.7, // bilabial closure — kept higher for visible lip contact
  v_ff: 0.58,
  v_th: 0.6,
  v_dd: 0.62,
  v_kk: 0.62,
...
export const CHAR_WEIGHT_OVERRIDE = {
  m: 0.55,
  M: 0.55, // bilabial nasal — lip closure visible but softer than stop
  b: 0.72,
  B: 0.72, // voiced stop — fuller closure than nasal
  p: 0.78,
  P: 0.78, // voiceless stop — hardest bilabial contact
};
...
export const DEFAULT_CONSONANT_WEIGHT = 0.3;
