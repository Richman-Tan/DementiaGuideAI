 ...
 * translator (packages/core/avatar/blendshapeTranslator.js) so baseline
...
const { visemeTimelineToCC4, visemeTimelineToEvents } =
  loadModule(path.join(__dirname, '../../packages/core/avatar/blendshapeTranslator.js'));
const { createVisemeTimeline } =
  loadModule(path.join(__dirname, '../../packages/core/lipsync/createVisemeTimeline.js'));
