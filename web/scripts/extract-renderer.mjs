...
// (src/features/avatar/components/AvatarVRM.js buildHTML()) into
// web/src/avatar/three/renderer.js.
//
...
const SRC = path.resolve(__dirname, '../../src/features/avatar/components/AvatarVRM.js');
...
const replacements = [
  ...
  // DRACO decoders served locally (web/public/draco/)
...
const header = `// GENERATED by web/scripts/extract-renderer.mjs from
// src/features/avatar/components/AvatarVRM.js — DO NOT EDIT BY HAND.
